...
XMVECTOR Camera::GetPositionXM( void ) const
{
...
XMVECTOR Camera::GetRightXM( void ) const
{
...
XMVECTOR Camera::GetUpXM( void ) const
{
...
XMVECTOR Camera::GetLookXM( void ) const
{
...
XMMATRIX Camera::View( void ) const
{
	return XMLoadFloat4x4( &mView );
}

XMMATRIX Camera::Proj( void ) const
{
	return XMLoadFloat4x4( &mProj );
}

XMMATRIX Camera::ViewProj( void ) const
{
